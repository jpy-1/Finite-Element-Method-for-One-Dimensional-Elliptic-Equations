% convergence_order_compute1.m 计算使用线性基函数空间的有限元解的收敛阶
clear; clc;
fem_obj=fem_class();
...
for i=2:num_N
    N=N_list(i);
    %误差计算
    u_fem_2=fun_fem1(N,fem_obj);
    error_2=error_compute1(u_fem_2,fem_obj,N);
...
filename = fullfile(pwd, 'error_convergence1.csv'); % 保存到当前工作目录
